...
func (c *relayClient) Relay(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/x.blockpi.indexer.Relay/Relay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRelayServer) Relay(context.Context, *Request) (*Response, error) {
...
func _Relay_Relay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelayServer).Relay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/x.blockpi.indexer.Relay/Relay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelayServer).Relay(ctx, req.(*Request))
	}
...
var Relay_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "x.blockpi.indexer.Relay",
